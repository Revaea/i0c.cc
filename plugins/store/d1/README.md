...
D1 is the second Store implementation used to validate the protocol. A host must inject a D1 binding before selecting this plugin; migrations are never applied automatically.
